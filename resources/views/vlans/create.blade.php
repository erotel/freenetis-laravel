...
@section('breadcrumbs')
<div id="breadcrumbs">
    <a href="{{ route('vlans.index') }}">VLANy</a> &raquo; Přidat VLAN
</div>
@endsection
@section('content')
<div class="m-page">
<div class="m-title-row"><h2>Přidat VLAN</h2></div>
...
<div class="m-card" style="margin-bottom:16px;max-width:420px">
    <div class="m-form-group">
        ...
        <input class="m-form-input" type="number" id="tag_802_1q" name="tag_802_1q"
               value="{{ old('tag_802_1q') }}" min="1" max="4094" style="max-width:120px">
...
<div class="m-actions">
    ...
    <a class="m-btn" href="{{ route('vlans.index') }}">Zrušit</a>
</div>
</form>
</div>
@endsection
