...
<head>
<meta charset="utf-8">
<title>Podpis dodatku – změna tarifu — PVfree.net</title>
...
<h1>Podpis dodatku – změna tarifu</h1>
...
<div id="metaBox" class="m-card" style="display:none">
    ...
    <p class="muted" style="margin-top:10px">
        Tento formulář slouží k elektronickému podpisu dodatku o změně tarifu.
...
(function(){
    ...
    const URLS = {
        info:        @json(route('sign.tariff_addon.info')),
        preview:     @json(route('sign.tariff_addon.preview')),
        otpSend:     @json(route('sign.addon.otp.send')),
        otpVerify:   @json(route('sign.tariff_addon.otp.verify')),
    };
