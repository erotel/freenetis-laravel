...
<div class="m-card" style="margin-bottom:16px;padding:14px 1.25rem">
    <form method="GET" action="{{ route('members.index') }}" style="display:flex;flex-wrap:wrap;gap:10px;align-items:flex-end;">
        ...
        <div>
            ...
            <select class="m-form-select" style="width:180px" name="types" onchange="this.form.submit()">
...
{{-- Pokročilé filtry --}}
<div class="m-card" style="margin-bottom:16px;padding:14px 1.25rem">
    <x-filter-bar :fields="$filterFields" :action="route('members.index')" :current="$currentFilters" />
</div>
